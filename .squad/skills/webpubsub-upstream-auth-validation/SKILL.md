...
- `tests\SquadScout.Broker.Tests\PubSubUpstreamHandlerTests.cs` covers accepted signed requests, accepted managed-identity requests, and rejected missing/invalid/untrusted requests.
